          ...
          return (
            ...
            >
              <Toast.Content className="flex items-center justify-between gap-1.5 overflow-hidden text-sm transition-opacity duration-250 data-behind:pointer-events-none data-behind:opacity-0 data-expanded:pointer-events-auto data-expanded:opacity-100">
                ...
                <Toast.Close className="absolute top-2 right-2 opacity-70 p-1 rounded-[4px] bg-transparent hover:bg-accent transition-opacity hover:opacity-100 focus:outline-none" data-slot="toast-close">
                  <X className="h-4 w-4" />
                </Toast.Close>
              </Toast.Content>
            </Toast.Root>
